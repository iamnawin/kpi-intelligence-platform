...
const SEVERITY_CONFIG: Record<AlertSeverity, { icon: React.ElementType; className: string; label: string }> = {
  critical: { icon: XCircle, className: "text-red-600 bg-red-50 border-red-200", label: "Critical" },
  warning: { icon: AlertTriangle, className: "text-yellow-700 bg-yellow-50 border-yellow-200", label: "Warning" },
