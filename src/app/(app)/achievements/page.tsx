      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Track outcomes with verifiable evidence. Every completed achievement becomes portable proof.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6">
          <div className="relative overflow-hidden rounded-2xl border border-gray-800 bg-gray-900 p-10 text-center">
            ...
            <p className="mx-auto mb-6 max-w-md text-sm leading-relaxed text-gray-400">
              Achievements are the core of ProofPath. Each one tracks progress, links to evidence,
              and builds a verifiable record — so every outcome is provable.
            </p>
            ...
            {[
              {
                ...
                desc: "Set a target, log progress, and watch your % tick up as the work gets done.",
              },
              {
                icon: Shield,
                ...
                desc: "Link reports, screenshots, and data exports. Each piece raises your trust level.",
              },
              {
                icon: CheckCircle2,
                ...
                title: "Prove Impact",
                desc: "Once manager-approved, your outcomes become locked, portable proof of work.",
              },
            ].map(card => (
          ...
          <div className="flex items-center justify-center gap-1 text-sm text-gray-600">
            <span>Or view your proof summary</span>
