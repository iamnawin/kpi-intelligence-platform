...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen bg-gray-950">
      <div className="relative hidden overflow-hidden border-r border-gray-800/60 bg-gray-950 p-12 lg:flex lg:w-[58%] lg:flex-col lg:justify-between">
        ...
        <div className="relative">
          ...
          <p className="mb-8 max-w-md text-base leading-relaxed text-gray-400">
            Stop guessing. Track what matters, set goals your team can prove, and build an
            evidence trail from first metric to locked outcome.
          </p>
        ...
        <div className="relative">
          <div className="rounded-xl border border-gray-800 bg-gray-900/60 p-4 backdrop-blur-sm">
            <div className="mb-2 flex gap-0.5">
              {[1, 2, 3, 4, 5].map(i => (
                <svg key={i} className="h-3.5 w-3.5 fill-current text-amber-400" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
              ))}
            </div>
            <p className="text-sm italic text-gray-300">
              &ldquo;ProofPath transformed how we communicate impact to stakeholders. Every goal now
              has a verifiable evidence chain.&rdquo;
            </p>
